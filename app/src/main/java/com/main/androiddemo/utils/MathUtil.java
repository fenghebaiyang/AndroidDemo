...
public class MathUtil {
    ...
    public static String priceForAppWithSign(String value) {
        return "¥" + priceForAppWithOutSign(value);
    }
    ...
    public static String priceForAppWithOutSign(String value) {
        return priceForAppWithOutSign(stringToDouble(value));
    }
    ...
    public static String priceForAppWithOutSign(double value) {
        return keepMost2Decimal(value);
        /*DecimalFormat df = new DecimalFormat("##0.00");
        String price = df.format(value);
        if (price.endsWith(".00$")) {
            price = price.substring(0, price.length() - 3);
        } else if (price.endsWith("\\.[\\d]0$")) {
